<article class="tengah">
  ...
  $data = mysqli_query($koneksi, "select * from struktur_organisasi where id_jenis = '4' and periode='$periode'  ");
  ...
  <?php
  $data = mysqli_query($koneksi, "select * from perangkat where id_jenis = '4' and periode='$periode' ");
