...
<table border="1" id="theTable">
  <tr>
    ...
    $data = mysqli_query($koneksi, "select * from perangkat where id_jenis = '1' limit $page2,10 ");
    while ($stk = mysqli_fetch_array ($data)) {
...
<hr>Halaman <br>
<?php
$query= mysqli_query($koneksi, "select * from perangkat where id_jenis='1' ");
